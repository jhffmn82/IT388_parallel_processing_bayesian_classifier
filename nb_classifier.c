 ...
 *           This is the simple baseline version before adding MPI or OpenMP.
 *
 * Course:   IT 388 Parallel Processing
 * Group:    Justin Hoffman, Nathan Wolniak, Brady Davidson
 *
 * Compile:  gcc -O2 -Wall -fopenmp nb_classifier.c -lm -o nb_serial
 * Run:      ./nb_serial <meta.csv> <labeled.csv> <unlabeled.csv> <output.csv> <k> <num_processes>
 *
 * Notes:
 *   1. Laplace smoothing is fixed at 1.0 in this version.
 *   2. num_processes is a placeholder kept for consistency with the parallel versions.
 */
